original source: [adventofcode.com/year2024/day/6](https://adventofcode.com/2024/day/6)
...
You start by making a map (your puzzle [input](https://github.com/Kidchai/AdventOfCode/blob/main/src/year2024/Day06/input.txt)) 
...
in a loop. The diagrams of these six situations use `O` to mark the new obstruction, `|` to show a position where 
