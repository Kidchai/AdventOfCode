original source: [adventofcode.com/year2022/day/10](https://adventofcode.com/2022/day/10)
...
The CPU uses these instructions in a program (your puzzle 
[input](https://github.com/Kidchai/AdventOfCode/blob/main/src/year2022/Day10/input.txt)) to, somehow, tell the screen 
what to draw.
...
[sprite](https://en.wikipedia.org/wiki/Sprite_(computer_graphics)) is 3 pixels wide, and the `X` register sets the 
horizontal position of the middle of that sprite. (In this system, there is no such thing as "vertical position": if the 
